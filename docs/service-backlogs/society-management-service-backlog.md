# Society Management Service - Service Backlog

## Scope
Society operations: buildings, maintenance, complaints, meetings, parking, visitors.

## Sprint Alignment
S7, S8, S9

## Primary Files
- Frontend: src/app/core/services/society-management.service.ts
- Backend: backend/src/modules/society
...
1. Update/create service methods in src/app/core/services/society-management.service.ts.
...
1. Add controllers/services under backend/src/modules/society.
