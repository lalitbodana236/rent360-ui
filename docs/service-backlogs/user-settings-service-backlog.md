# User Settings Service - Service Backlog

## Scope
Profile, preferences, currency, locale, and default dashboard preferences.

## Sprint Alignment
S11, S12

## Primary Files
- Frontend: src/app/core/services/user-settings.service.ts
...
1. Update/create service methods in src/app/core/services/user-settings.service.ts.
...
1. Add controllers/services under backend/src/modules/settings.
