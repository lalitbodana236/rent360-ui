# API Client Service - Service Backlog

## Scope
Centralized API transport, retries, error mapping, and environment switching.

## Sprint Alignment
S1, S2, S12

## Primary Files
- Frontend: src/app/core/services/api-client.service.ts
- Backend: backend/src/common/http
...
1. Update/create service methods in src/app/core/services/api-client.service.ts.
...
1. Add controllers/services under backend/src/common/http.
