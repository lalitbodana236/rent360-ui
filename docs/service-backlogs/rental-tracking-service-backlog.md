# Rental Tracking Service - Service Backlog

## Scope
Rent lifecycle, dues status, and tenant-facing payment context.

## Sprint Alignment
S5, S6

## Primary Files
- Frontend: src/app/core/services/rental-tracking.service.ts
...
1. Update/create service methods in src/app/core/services/rental-tracking.service.ts.
...
1. Add controllers/services under backend/src/modules/payments.
