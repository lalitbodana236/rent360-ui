# Auth Service - Service Backlog

## Scope
Secure login/session, token lifecycle, and role-aware user context.
...
1. Update/create service methods in src/app/core/services/auth.service.ts.
...
1. Add controllers/services under backend/src/modules/auth.
