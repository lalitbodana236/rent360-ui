# Marketplace Data Service - Service Backlog

## Scope
Listings, media, inquiries, and conversion-oriented marketplace operations.

## Sprint Alignment
S10, S11

## Primary Files
- Frontend: src/app/core/services/marketplace-data.service.ts
...
1. Update/create service methods in src/app/core/services/marketplace-data.service.ts.
...
1. Add controllers/services under backend/src/modules/marketplace.
