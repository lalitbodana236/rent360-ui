# Communication Service (Planned) - Service Backlog

## Scope
Inbox, campaigns, templates, automations, delivery tracking, and audit logs.

## Sprint Alignment
S6, S7, S8, S11

## Primary Files
- Frontend: src/app/core/services/communication.service.ts (to create)
...
1. Update/create service methods in src/app/core/services/communication.service.ts (to create).
...
1. Add controllers/services under backend/src/modules/communications.
