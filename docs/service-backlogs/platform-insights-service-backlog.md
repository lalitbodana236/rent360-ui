# Platform Insights Service - Service Backlog

## Scope
Cross-module intelligence combining payments, occupancy, marketplace, and ops.

## Sprint Alignment
S3, S11

## Primary Files
- Frontend: src/app/core/services/platform-insights.service.ts
...
1. Update/create service methods in src/app/core/services/platform-insights.service.ts.
...
1. Add controllers/services under backend/src/modules/reports.
