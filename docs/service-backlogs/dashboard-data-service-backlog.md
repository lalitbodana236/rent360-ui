# Dashboard Data Service - Service Backlog

## Scope
Role-specific dashboard data aggregation and filter-aware KPIs.

## Sprint Alignment
S3, S11

## Primary Files
- Frontend: src/app/core/services/dashboard-data.service.ts
...
1. Update/create service methods in src/app/core/services/dashboard-data.service.ts.
...
1. Add controllers/services under backend/src/modules/dashboard.
